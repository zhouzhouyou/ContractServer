...
public interface ContractProcessMapper {
    ...
    ContractProcess select(String contractNum, OperationType type,String userName);
    ...
    int insert(String contractNum, OperationType type, OperationState state, String userName, String content, Date time);
